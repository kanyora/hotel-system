...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <![endif]-->
<script type="text/javascript" async="" src="file:///C|/Users/user/Desktop/site/Admin Control Panel3_files/ga.js"></script><script type="text/javascript">
        ...
        <div id="container">
          ...
          <div id="application">
            ...
            <nav id="primary">
              <ul>
                <li>
                  <a href="http://denk-groot.nl/admincp/">
                    <span class="icon dashboard"></span>
                    Dashboard                  </a>                </li>
                
                <li>
                  <a href="http://denk-groot.nl/admincp/forms">
                    <span class="icon pencil"></span>
                    Forms                  </a>                </li>
                
                <li class="current">
                  <a href="file:///C|/Users/user/Desktop/site/Admin Control Panel3_files/Admin Control Panel3.htm">
                    <span class="icon tables"></span>
                    DataTables                  </a>                </li>

                <li>
                  <a href="http://denk-groot.nl/admincp/charts">
                    <span class="icon chart"></span>
                    <span class="badge">4</span>
                    Charts                  </a>                </li>
                
                <li>
                  <a href="http://denk-groot.nl/admincp/notifications">
                    <span class="icon modal"></span>
                    Notifcations                  </a>                </li>

				<li>
                  <a href="http://denk-groot.nl/admincp/typography">
                    <span class="icon newspaper"></span>
                    Typography                  </a>                </li>

                <li>
                  <a href="http://denk-groot.nl/admincp/buttons">
            ...
            <nav id="secondary">
              <ul>
                <li class="current"><a href="http://denk-groot.nl/admincp/tables#maintab">Main tab</a></li>
                <li><a href="http://denk-groot.nl/admincp/tables#secondtab">Explanation tabs</a></li>
                <li><a href="http://denk-groot.nl/admincp/tables#thirdtab">Optional third tab</a></li>
              </ul>
            </nav>
...
<div class="column left third">
  <h3>Instructions</h3>
  <p>The only thing you have to do to create this interactive table is add the following class to a table.</p>
  <pre>&lt;table class="datatable"&gt;</pre>
</div>

<div class="column right twothird">  
  <div class="dataTables_wrapper"><div class="dataTables_length"><label>Show <div class="cmf-skinned-select" style="width: 100px; height: 0px; background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); font-size: 13px; font-family: Arial; font-style: normal; position: relative; "><div class="cmf-skinned-text" style="height: 3px; width: 91px; opacity: 100; overflow-x: hidden; overflow-y: hidden; position: absolute; text-indent: 0px; z-index: 1; top: 0px; left: 0px; ">10</div><select size="1" style="opacity: 0; position: relative; z-index: 100; "><option value="10" selected="selected">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></div> entries</label></div><div class="dataTables_filter"><label><input type="text"></label></div><table class="vehicle">
    <thead>
      <tr>
        ...
        <th class="sorting" rowspan="1" colspan="1" style="width: 157px; ">Email</th><th class="sorting" rowspan="1" colspan="1" style="width: 205px; ">Actions</th></tr>
    </thead>
  ...
  <tbody><tr class="odd">
        ...
        <td>
          <span class="button-group">
            ...
            <a href="http://denk-groot.nl/admincp/tables#" class="button icon remove danger">Remove</a>          </span>        </td>
      </tr><tr class="even">
        <td class=" sorting_1">Another Guy</td>
        <td>His real name</td>
        <td>&nbsp;</td>
  ...
  <div class="dataTables_info">Showing 1 to 10 of 12 entries</div><div class="dataTables_paginate paging_two_button"><div class="paginate_disabled_previous" title="Previous"></div><div class="paginate_enabled_next" title="Next"></div></div></div>
</div>
...
<div id="livesearch" style="display: none; "></div></body></html>