<?php
	$stock_personel_list = new Route('/Pharmacy/staff/stock-personel/');
	...
	$stock_personel_view = new Route('/Pharmacy/staff/stock-personel/:id/');
